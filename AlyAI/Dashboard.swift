            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        VStack(spacing: 16) {
                            HStack(spacing: 12) {
                                DashboardMoodButton(emoji: "😄", label: "Very\nHappy", isSelected: selectedMood == "very_happy", action: {
                                    selectedMood = "very_happy"
                                })
                                DashboardMoodButton(emoji: "🙂", label: "Happy", isSelected: selectedMood == "happy", action: {
                                    selectedMood = "happy"
                                })
                                DashboardMoodButton(emoji: "😐", label: "Neutral", isSelected: selectedMood == "neutral", action: {
                                    selectedMood = "neutral"
                                })
                                DashboardMoodButton(emoji: "😔", label: "Sad", isSelected: selectedMood == "sad", action: {
                                    selectedMood = "sad"
                                })
                                DashboardMoodButton(emoji: "😢", label: "Very Sad", isSelected: selectedMood == "very_sad", action: {
...
struct DashboardMoodButton: View {
    let emoji: String
    let label: String
    let isSelected: Bool
    let action: () -> Void
